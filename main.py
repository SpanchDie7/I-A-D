...
from RK1.classBrowserComputer import BrowserComputer
from RK1.ClassBrowser import Browser
from RK1.ClassComputer import Computer
...
def main():
    ...
    res1={}
   # res = list(filter(lambda i: i[0].startswith('A'), one_to_many))
